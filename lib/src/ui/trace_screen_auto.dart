...
class TraceScreen2 extends StatefulWidget {
  const TraceScreen2({Key? key}) : super(key: key);

  @override
  State<TraceScreen2> createState() => _TraceScreenState();
}

class _TraceScreenState extends State<TraceScreen2> {
  ...
  void initState() {
    super.initState();
    // Start the scan automatically when the app loads
    performTraces();
  }
